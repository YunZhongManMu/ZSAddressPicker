...
- (void)loadAddressMessage {
    ...
    NSString *filePath = [[NSBundle mainBundle] pathForResource:@"chinaAddress" ofType:@"plist"];
    
    NSDictionary *addressDictionary = [[NSDictionary alloc] initWithContentsOfFile:filePath];
    
    self.china = [[China alloc] initWithDict:addressDictionary];
